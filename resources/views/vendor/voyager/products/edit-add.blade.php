                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="title">{{ $row->getTranslatedAttribute('display_name') }}</label>
                            ...
                            @endphp
                            <div class="form-group">
                                <label for="description">{{ $row->getTranslatedAttribute('display_name') }}</label>
                                <span class="language-label js-language-label"></span>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'description',
                                    '_field_trans' => get_field_translations($dataTypeContent, 'description')
                                ])
                                <textarea class="form-control" rows="4" name="description">{{ $dataTypeContent->description ?? '' }}</textarea>
                            </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{  __('generic.detail') }}</h3>
                        ...
                        <div class="panel-body">
                            @php
                                $exclude = ['title', 'body', 'description', 'meta_description', 'meta_keywords', 'seo_title'];
                            @endphp
