...
<head>
    ...
    <title>Admin - {{ __('login.welcome') }}</title>
    ...
    <style>
        body {
            <?php $bg = rand(1, 7); ?>
            background-image:url('{{ Voyager::image( Voyager::setting("admin.bg_image"), asset("img/background/$bg.jpg") ) }}');
